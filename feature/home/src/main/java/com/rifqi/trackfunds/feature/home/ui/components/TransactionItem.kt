...
class TransactionItemPreviewParameterProvider : CollectionPreviewParameterProvider<TransactionItem>(
    listOf(
        TransactionItem(
            id = "1",
...
private fun TransactionItemPreview(
    @PreviewParameter(TransactionItemPreviewParameterProvider::class) transactions: TransactionItem
) {
    TrackFundsTheme {
        TransactionItem(
